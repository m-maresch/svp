...
| `related_rows` | Int | 1 | Number of rows for the **Related** grid. |
| `related_cols` | Int | 4 | Number of columns for the **Related** grid. |
| `library_rows` | Int | 1 | Number of rows for the **Library** grid. |
| `library_cols` | Int | 4 | Number of columns for the **Library** grid. |
